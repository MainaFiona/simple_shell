...
/**
 *struct passinfo - pseudo-args that will pass into a function,
 *@arg: string to be generated from getline containing args
 ...
 *@cmd_buff: address of pointer, on if chaining
 *@cmd_buff_type: CMD_type ||, &&, ;
 *@readfd: read from where to read line input
